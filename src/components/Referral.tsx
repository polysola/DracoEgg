    ...
    <div className="space-y-6 pb-24 font-orbitron">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="glass-card p-4 rounded-[24px] text-center premium-shadow relative overflow-hidden group border-[rgba(155,0,255,0.3)]">
          <div className="absolute inset-0 bg-gradient-to-br from-[#8b5cf6]/15 to-transparent"></div>
          <div className="bg-[#8b5cf6]/15 w-10 h-10 rounded-2xl flex items-center justify-center mx-auto mb-3 border border-[#8b5cf6]/40">
          ...
          <p className="text-2xl font-black text-[#f0eeff] neon-purple-glow">{users.length > 0 ? users[0].referrals.length : 0}</p>
        </div>

        <div className="glass-card p-4 rounded-[24px] text-center premium-shadow relative overflow-hidden group border-[rgba(155,0,255,0.3)]">
          <div className="absolute inset-0 bg-gradient-to-br from-[#00d2ff]/10 to-transparent"></div>
          <div className="bg-[#00d2ff]/10 w-10 h-10 rounded-2xl flex items-center justify-center mx-auto mb-3 border border-[#00d2ff]/30">
      ...
      <div className="glass-card p-5 rounded-[28px] premium-shadow border-t border-[rgba(155,0,255,0.3)]">
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="bg-[#8b5cf6]/20 px-2.5 py-1 rounded-lg border border-[#8b5cf6]/40">
            <span className="text-[9px] text-[#c084fc] font-black tracking-tighter">PREMIUM BONUS</span>
          </div>
        </div>
        <div className="bg-[#070514]/90 p-4 rounded-2xl border border-[#8b5cf6]/30 flex justify-between items-center">
          <p className="text-xs text-[#c084fc] font-mono font-bold truncate max-w-[150px]">{currentUser || "Unknown"}</p>
          <button
            onClick={handleCopyLink}
            className="bg-gradient-to-r from-[#8b5cf6] via-[#a855f7] to-[#00d2ff] hover:opacity-90 text-white text-[11px] font-black px-4 py-2 rounded-xl transition-all shadow-[0_0_15px_rgba(139,92,246,0.5)]"
          >
            COPY LINK
          </button>
        </div>
