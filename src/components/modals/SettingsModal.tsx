      ...
      <div className="w-full max-w-md bg-[#0a0720] border border-[#8b5cf6]/40 rounded-[28px] p-6 text-[#f0eeff] shadow-[0_0_50px_rgba(139,92,246,0.3)] relative max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex justify-between items-center mb-4">
          <div className="flex items-center space-x-2">
            <div className="w-3 h-3 rounded-full bg-[#00d2ff] animate-ping"></div>
        ...
        <div className="space-y-3 mb-4">
          <div className="flex justify-between items-center bg-[#070514] p-3.5 rounded-2xl border border-white/10">
            <div>
            ...
            <button
              ...
              className={`w-12 h-7 rounded-full p-1 transition-all ${
                soundEnabled ? "bg-gradient-to-r from-[#8b5cf6] to-[#00d2ff]" : "bg-gray-700"
              }`}
            >
          ...
          <div className="flex justify-between items-center bg-[#070514] p-3.5 rounded-2xl border border-white/10">
            ...
            <button
              ...
              className={`w-12 h-7 rounded-full p-1 transition-all ${
                hapticsEnabled ? "bg-gradient-to-r from-[#8b5cf6] to-[#00d2ff]" : "bg-gray-700"
              }`}
            >
          ...
          <div className="bg-[#070514] p-3.5 rounded-2xl border border-white/10">
              ...
              {(["Low", "High", "Cyber Ultra"] as const).map((q) => (
                <button
                  ...
                  className={`py-1.5 rounded-xl text-[11px] font-black transition-all ${
                    graphicsQuality === q
                      ? "bg-[#00d2ff] text-black shadow-[0_0_12px_#00d2ff]"
        ...
        <button
          onClick={onClose}
          className="w-full py-3.5 rounded-2xl bg-gradient-to-r from-[#8b5cf6] via-[#a855f7] to-[#00d2ff] text-white font-black text-sm uppercase tracking-wider shadow-[0_0_25px_rgba(168,85,247,0.4)] hover:opacity-90 transition-all"
        >
          Save & Apply Settings
        </button>
      </div>
